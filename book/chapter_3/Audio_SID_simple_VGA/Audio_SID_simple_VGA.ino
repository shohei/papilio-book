 ...
 */
///****************************************************************************
// File Name            : Audio_SID_simple_VGA.ino
//-----------------------------------------------------------------------------
// Function             : Audio_SID + VGA
//                        
//-----------------------------------------------------------------------------
// Designer             : yokomizo 
//-----------------------------------------------------------------------------
...
void setup() {
 ...
 //Setup timer for YM and mod players, this generates an interrupt at 1700hz
  ...
  VGA.setColor(GREEN);
  VGA.printtext(10,0,"Papilio/ZPUino/PSL");
  ...
  */
  ...
  VGA.printtext(35,10,"Hello World");
  VGA.setColor(GREEN);
  VGA.printtext(35,20,"Hello World");
  VGA.setColor(BLUE);
  VGA.printtext(35,30,"Hello World");
}
